...
namespace PayFlow.Reconciliation.API.Auth;

/// <summary>
/// Validates JWTs that Identity issues. Same shape as the Transaction
/// service's helper — kept duplicated until the third service needs it
/// (then it lifts into PayFlow.Multitenancy or its own building block).
/// </summary>
